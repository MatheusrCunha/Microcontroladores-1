 ...
 *
 *      Adaptado de AVR e Arduino: Tecnicas de Projeto, 2a ed. - 2012.
...
/**
  * @brief  Envia um dado estatico para o display: caractere ou comando.
...
/**
  * @brief  Escreve um string estatica (sem printf) no LCD.
